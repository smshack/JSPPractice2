						...
						<tbody>
							...
							<c:forEach var="n" items="${list}" begin="0" end="10">
								<tr>
									...
									<td>${n.writerid }</td>
									<td>
										<!-- format태그를 이용한 날짜 형식 변경 --> <fmt:formatDate
											value="${n.regdate }" pattern="yyyy년  MM월 dd일" /> <%-- <fmt:formatDate value="${n.regdate }" pattern="yyyy-MM-dd hh:mm:ss"/>		 --%>
									</td>
									<td>${n.hit }</td>
								</tr>
							</c:forEach>
